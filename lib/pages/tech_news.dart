...
import 'package:assgn_digia_tech/services/tech_news_service.dart';
...
class _TechNewsState extends State<TechNews> {
  bool _loading = true;
  var newsList;
  List<NewsModel> techArticles = [];
  void getTechNews() async {
    TechNewsService apiNews = TechNewsService();
    await apiNews.getTechNews();
    techArticles = apiNews.apiTechNews;
    setState(() {
      _loading = false;
    });
  }
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          techArticles[index].description,
                                          style: TextStyle(
